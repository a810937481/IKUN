...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/static/css/search.css"/>
...
<main>
    ...
    <div class="content">
        <article class="content__item">
            ...
            <a class="content__item-title" href="${ctx}/queryById?id=3">南京——中山陵</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=6">西安</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=2">南京——夫子庙</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=7">北京——颐和园</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=8">北京——天安门</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=9">北京——故宫</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=10">苏州——苏州园林</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=11">苏州——太湖景区</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=12">苏州——常熟虞山公园</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=13">上海——外滩</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=14">上海——迪士尼乐园</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=15">上海——陆家嘴</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=16">重庆——洪崖洞</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=17">重庆——万州大瀑布</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=18">西安——大雁塔</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=19">昆明——滇池</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=20">昆明——南屏街</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="21">成都——太古里</a>
        ...
        <article class="content__item">
            ...
            <div class="content__item-copy">
                <a class="content__item-title" href="${ctx}/queryById?id=22">成都——熊猫基地</a>
